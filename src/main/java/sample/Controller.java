...
public class Controller implements Initializable {
    ...
    public javafx.scene.control.Button ArrayButton1;
    public javafx.scene.control.Button ArrayButton2;
    public javafx.scene.control.Button ArrayButton3;
    public javafx.scene.control.Button ArrayButton4;
    public javafx.scene.control.Button ArrayButton5;
    public javafx.scene.control.Button ArrayButton6;
    public javafx.scene.control.Button ArrayButton7;


    public void setCreature(int x, int y, Creature creature){
        allImageView[x][y].setImage(creature.getImage());
    }
    public void setDeadCreature(int x, int y, Creature creature){
        allImageView[x][y].setImage(creature.getDeadImage());
    }
