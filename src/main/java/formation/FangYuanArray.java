...
public class FangYuanArray extends Formation {
    ...
    public BattleField embattle(Creature[] creatures){
        ...
        if(row<5 || column<5){
            ...
            newRoles[3].setPosition(new Position(vacancyRow,vacancyColumn+2+11));
            newRoles[1].setPosition(new Position(vacancyRow+1,vacancyColumn+1+11));
            newRoles[5].setPosition(new Position(vacancyRow+1,vacancyColumn+3+11));
            newRoles[0].setPosition(new Position(vacancyRow+2,vacancyColumn+11));
            newRoles[7].setPosition(new Position(vacancyRow+2,vacancyColumn+4+11));
            newRoles[2].setPosition(new Position(vacancyRow+3,vacancyColumn+1+11));
            newRoles[6].setPosition(new Position(vacancyRow+3,vacancyColumn+3+11));
            newRoles[4].setPosition(new Position(vacancyRow+4,vacancyColumn+2+11));
        }
        return field;
    }
}
